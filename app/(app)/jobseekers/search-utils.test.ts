...
describe("validateSortColumn", () => {
  test("should return default 'created_at' for undefined", () => {
    assert.strictEqual(validateSortColumn(undefined), "created_at");
  });

  test("should return default 'created_at' for empty string", () => {
    assert.strictEqual(validateSortColumn(""), "created_at");
  });

  test("should return valid columns as-is", () => {
  ...
  test("should return default for invalid columns", () => {
    ...
    assert.strictEqual(validateSortColumn("skills"), "created_at"); // Not in allowlist yet
  });
});
