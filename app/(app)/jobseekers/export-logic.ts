...
export interface JobseekerExportFilters {
  search?: string;
  sex?: string;
...
export async function generateJobseekersCSV(
  supabase: SupabaseClient,
  filters: JobseekerExportFilters
  ...
  try {
    ...
    // Using string concatenation is much faster and memory efficient than Array.push
    const headersString = headers.join(",");
    let csv = headersString + "\n";
    ...
    console.error("generateJobseekersCSV error:", error);
