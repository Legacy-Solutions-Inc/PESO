        ...
        <section className="relative flex flex-col justify-center">
          ...
          <Reveal delay={280}>
            <p className="mt-6 max-w-lg text-[15px] leading-relaxed text-muted-foreground">
              ...
              Registration Form. Sign in with the account provisioned by your
              PESO administrator.
            </p>
          </Reveal>
          ...
          <Reveal delay={160} className="w-full max-w-[440px]">
            ...
            >
              <div className="mb-8">
                ...
                <h2
                  id="sign-in-heading"
                  className="font-serif text-[2rem] font-medium leading-tight tracking-[-0.02em] text-foreground"
                >
                  Sign in
                </h2>
                <p className="mt-2 text-[13.5px] leading-relaxed text-muted-foreground">
                  Sign in with your PESO staff account, or request one below.
